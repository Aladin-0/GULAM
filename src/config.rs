...
impl Config {
    pub fn load() -> Self {
        ...
        Self {
            ...
            initial_capital: env::var("INITIAL_CAPITAL").unwrap_or_else(|_| "15.0".to_string()).parse().unwrap_or(15.0),
            max_position_size_pct: env::var("MAX_POSITION_SIZE_PCT").unwrap_or_else(|_| "0.30".to_string()).parse().unwrap_or(0.30),
